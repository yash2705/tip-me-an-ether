...
const Hero = () => {
  ...
  const styles = {
    ...
    container: `flex items-center justify-between rounded-full text-white drop-shadow-lg text-xl md:bg-violet-600 w-4/5 sm:w-2/3 lg:w-2/5 sm:hover:scale-105 transition duration-500 ease-in-out bg-violet-700`,
