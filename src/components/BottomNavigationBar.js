...
const BottomNavigationBar = () => {
  const styles = {
    wrapper: `flex items-center justify-around text-sm text-white px-2 w-screen md:hidden shadow-md py-3 fixed bottom-0 left-0 right-0 bg-violet-600`,
    optionContainer: `items-center flex flex-col w-1/3`,
    optionLogo: `text-white
