...
const Header = () => {
  const styles = {
    wrapper: `flex justify-between rounded-full max-w-6xl lg:mx-auto md:sticky md:top-4 md:bg-violet-600 md:mx-4 md:drop-shadow-lg text-white p-4 md:p-0`,
    leftSection: `flex items-center`,
    option: `rounded-full p-2 mt-2 mb-2 ml-2 hover:bg-indigo-700 hover:cursor-pointer font-medium md:m-3`,
